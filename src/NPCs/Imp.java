...
public class Imp extends NPC {
    ...
    public Imp(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Imp Spritesheet.png"), 32, 32), "STAND_LEFT");
    ...
    public Rectangle getInteractionRange() {
        return new Rectangle(
                ...
                getBounds().getWidth() + (interactionRange * 12),
                getBounds().getHeight() + (interactionRange * 12)
        );
    }
